...
export const projects: Project[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: ["The enclosure used laser-cut wood and acrylic.", "Parametric CAD and DXF files were prepared to a ±0.5 mm tolerance so the team could fabricate, assemble, and revise the design efficiently.", "Designed around 30 × 30 × 40 cm parcels."],
      ...
      },
      {
        ...
        body: ["Latch cycling: 600 cycles.", "Retention test: 60 N.", "Drop test: 1 m with a 5 kg load.", "Insertion testing: 200 trials.", "Test logs guided design changes that reduced false triggers below 2%."],
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "data-acquisition", eyebrow: "02 / Data acquisition", title: "Time-aligned vibration and speed measurements.", body: ["Integrated synchronized data acquisition on an ESP32.", "Captured vibration using an ADXL345 accelerometer over I2C.", "Measured RPM with a Hall sensor.", "This connects the captured vibration data to motor speed."] },
      { id: "signal-analysis", eyebrow: "03 / Signal analysis", title: "Compare vibration across speed and mounting conditions.", body: ["Quantified vibration versus speed using RMS and peak metrics.", "Used FFT analysis to compare the isolation effectiveness of the interchangeable mounts."] },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        body: ["Defined seven measurable requirements for a drone-enabled medical supply hub.", "Translated the requirements into a verification matrix covering fit, load, drop, and usability."],
      ...
      },
      {
        ...
        body: ["Fabricated a 3D-printed interface.", "Validated the prototype with a 3-ft drop test and a 5-lb load test."],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: ["Five-person team led from design through validation.", "The team repeated build and load-test cycles until the bridge reportedly supported a 120 kg load, 25% above the competition average.", "Performance measured through iterative stress and load testing."],
