...
const details: Record<string, CaseDetails> = {
  "nvh-test-rig": {
    ...
    ownership: ["Engineered the controlled validation rig as a personal project.", "Integrated synchronized ESP32 data acquisition with the ADXL345 and Hall sensor.", "Quantified vibration versus speed using RMS/peak metrics and FFT."],
    ...
    build: ["Excitation: DC motor + ERW.", "Interchangeable mounts: rigid, rubber, and isolator.", "Data acquisition: ESP32 with an ADXL345 accelerometer over I2C.", "Speed measurement: Hall sensor for RPM."],
  ...
  "smart-delivery-box": {
    ...
    validation: ["Reported latch cycling: 600 cycles.", "Reported retention test: 60 N.", "Reported drop test: 1 m with a 5 kg payload.", "Reported insertion testing: 200 trials.", "These describe test conditions and scope; they do not establish that every test passed."],
  ...
  "hybrid-health-supply-network": {
    ...
    ownership: ["I directed the four-member team in defining seven measurable requirements.", "Built the verification matrix.", "Used a weighted decision matrix to select concepts.", "Fabricated and tested the 3D-printed interface.", "The broader supply-hub concept was a team project; the current record does not assign every subsystem to an individual."],
  ...
  "f-race": {
    ...
    ownership: ["Produced AutoCAD part and assembly drawings and maintained drawing revisions.", "Supported technical experts with SolidWorks Simulation.", "Implemented design updates.", "The structural analysis and complete vehicle were collaborative work; my role was drawing production and analysis support."],
